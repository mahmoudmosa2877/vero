...
server.unifiedServer = function (req, res) {
  ...
  req.on("end", async function () {
    ...
    // check for public/ and serving static assets
    console.log(trimmedPath, trimmedPath.indexOf("public/"));
    // choosenHandler =
    //   trimmedPath.indexOf("public/") != -1 ? views.public : choosenHandler;
    ...
    try {
      ...
      if (contentType == "favicon") {
        ...
        // Use the payload returned from the handler, or set the default payload to an empty string
        console.log(typeof respon?.payload !== undefined);
        payloadString =
          typeof respon?.payload !== undefined ? respon.payload : "";
      }
